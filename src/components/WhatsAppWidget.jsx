...
const WhatsAppWidget = () => {
    return (
        ...
        >
            ...
            <div className="relative bg-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl hover:scale-110 transition-all duration-300">
